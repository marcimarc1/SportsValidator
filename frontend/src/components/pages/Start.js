...
class Start extends Component {
    ...
    render() {
        ...
        if(this.state.loggedIn) {
            buttons.push(<Link key={runningIndex++} to="/games">
            ...
            buttons = buttons.concat(
                ...
                <button  key={runningIndex++} className="StartButton turn-light-gray-on-hover"> Log In </button>,
                <button  key={runningIndex++} className="StartButton turn-light-gray-on-hover"> Register </button>]);
        }
        return (
