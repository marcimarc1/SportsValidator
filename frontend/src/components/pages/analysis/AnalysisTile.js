    ...
    if (
      ...
      switch (this.props.type) {
        case "distance-barchart":
          ...
          chart = (
            <BarChart
              ...
              groupByTeams={this.props.groupByTeams}
        ...
        case "heatmap":
          // TODO BACKEND maybe get team colors assigned to team from backend and pass them here so colors in chart match team colors?
          headingText =
            (this.props.groupByTeams ? "Team" : "Player") + " Position Heatmap";
          chart = (
            <Heatmap
        ...
        default:
          console.warn(
            "Encountered an unknown Tile Type (props.type): " + this.props.type,
          );
      }
    }
      ...
      <div className="AnalysisTile">
        <div className="AnalysisTileHeadingContainer">
          ...
          <div className="AnalysisTileButtonContainer">
            <IconButton
              size="medium"
              className={"AnalysisTileButton"}
              onClick={this.shiftLeft}
              aria-label="shift tile to the left"
            >
            ...
            <IconButton
              size="medium"
              className={"AnalysisTileButton right"}
              onClick={this.shiftRight}
              aria-label="shift tile to the right"
            >
              <FontAwesomeIcon
