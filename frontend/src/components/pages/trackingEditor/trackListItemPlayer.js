...
class TrackListItemPlayer extends Component {
    ...
    render() {
        ...
        return (
            <div className={"TrackListItem" + (bBox.my.selected ? " selected" : "") + classNameExpansionPostfix} style={style} onClick={clickItem}>
                ...
                <div className={"TrackListItemSwapOverlay" + classNameExpansionPostfix}>
                    <div className={"TrackListItemSwapOverlayContent" + classNameSwapMenuVisibility}>
                        <div className={"TrackListItemSwapOverlayContentText"}>Swap {bBox.my.name?bBox.my.name:("Player " + bBox.my.player)} with </div>
