...
class NavBar extends Component {
  ...
  render() {
    let visibilityOptions = ["always", "selected", "hover", "never"].map(
      (v, index) => (
    ...
    return (
      <div className="NavBar">
        ...
        <div className="NavBarUndoRedo">
          <FontAwesomeIcon
            icon={faUndo}
            onClick={this.props.undoRedo(true)}
            className={this.transportButtonSize + " NavBarUndoRedoIcon Pointer"}
          />
          <FontAwesomeIcon
            icon={faUndo}
            flip="horizontal"
            onClick={this.props.undoRedo(false)}
            className={this.transportButtonSize + " NavBarUndoRedoIcon Pointer"}
          />
        </div>
        <div className="NavBarTransport">
          <div className="NavBarTransportButtonContainer">
            <FontAwesomeIcon
              icon={faStepBackward}
              onClick={this.switchFrame(0)}
              className={
                this.transportButtonSize +
                " NavBarTransportButton NavBarTransportButtonFirst Pointer"
              }
            />
            <span
              onClick={this.switchFrameRelative(-this.bigStepSize)}
              className={
                this.transportButtonSize +
                " fa-layers fa-fw NavBarTransportButton  Pointer"
              }
            >
              {" "}
              {/* making a double chevron because fontawesome does not have one (double angle is scaled down)*/}
              <FontAwesomeIcon icon={faChevronLeft} />
              <FontAwesomeIcon icon={faChevronLeft} transform="right-6" />
            </span>
            <FontAwesomeIcon
              icon={faChevronLeft}
              onClick={this.switchFrameRelative(-1)}
              className={
                this.transportButtonSize + " NavBarTransportButton Pointer"
              }
            />
            <FontAwesomeIcon
              icon={faPlay}
              ...
              className={
                this.transportButtonSize +
                " NavBarTransportButton NavBarTransportButtonPlay Pointer" +
                (this.state.playing ? " remove" : "")
              }
            />
            <FontAwesomeIcon
              icon={faPause}
              ...
              className={
                this.transportButtonSize +
                " NavBarTransportButton NavBarTransportButtonPause Pointer" +
                (this.state.playing ? "" : " remove")
              }
            />
            <FontAwesomeIcon
            ...
            <span
              ...
              className={
                this.transportButtonSize +
                " fa-layers fa-fw NavBarTransportButton NavBarTransportButtonDoubleChevronRight Pointer"
              }
            >
              {" "}
              {/* making a double chevron because fontawesome does not have one (double angle is scaled down)*/}
            ...
            <FontAwesomeIcon
              icon={faStepBackward}
              flip="horizontal"
              onClick={this.switchFrame(this.props.maxFrame)}
              className={
                this.transportButtonSize +
                " NavBarTransportButton NavBarTransportButtonLast Pointer"
              }
            />
          </div>
          ...
          <div className="NavBarSlider">
            <Slider
              ...
              changeFrame={this.changeFrameViaSlider}
            />
          </div>
        </div>
        <div className="NavBarAppearanceSelectionContainer">
          {" "}
          {/* to bring inner elements a bit closer together */}
          <div className={"NavBarColorByCategorySwitch"}>
            <FormControl>
              <FormControlLabel
                control={
                  <Switch
                    checked={this.props.colorByCategory}
                    onChange={this.handleSwitchColorByCategory}
                  />
                }
                label={<div className="Label">Color by Teams</div>}
                labelPlacement="top"
              />
            </FormControl>
          </div>
          <div className="NavBarLabelVisibilityDropdown">
            ...
            <FormControl>
              <FormControlLabel
                ...
                label={<div className="Label">Label Visibility</div>}
                labelPlacement="top"
                sx={{ fontWeight: "light" }}
              />
