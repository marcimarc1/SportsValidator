...
class TrackListItemBall extends Component {
  ...
  delete = () => {
    if (window.confirm("Do you really want to delete this ball?")) {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="staticText">Ball ID: </div>
        <EditText
          className={
