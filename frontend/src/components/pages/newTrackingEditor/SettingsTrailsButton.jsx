import { Box, Button, Menu, Typography, FormGroup, FormControlLabel, Switch, Slider, TextField} from "@mui/material";
...
export const SettingsTrailsButton = ({
    ...
    <div>
      ...
      >
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 16px" }} onClick={handleEnablingTrails}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 16px" }} onClick={handleShowPlayerTrails}>
