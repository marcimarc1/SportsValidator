...
export const updateTimestamp = (newTimestamp, frameDuration, setTimestamp, setFrameNumber) => {
...
export const handleSeekPercent = (value, videoElement, setProgress, updateTimestamp) => {
    setProgress(value);
...
export const handleDisplayingAnnotation = (isShowingAnnotation, setIsShowingAnnotation) => {
