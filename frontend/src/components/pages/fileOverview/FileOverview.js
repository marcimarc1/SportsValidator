                    ...
                    <div className="FileOverviewHeadingContainer">
                        <div className={"FileOverviewAddButtonContainer" + classNameExpansionPostfix}>
                            ...
                            <form className={"FileInput" + classNameFileUploadPostfix} onSubmit={this.fileHandler}>
                                ...
                                {/*<input type="submit">*/}
                                    <IconButton className="FileInputCheckmark" type="submit" size="medium" variant="contained" aria-label="upload selected file">
                                        <FontAwesomeIcon className="" icon={faCheck} />
                                    </IconButton>
                                {/*</input>*/}
                            </form>
                            <IconButton size="medium" variant="contained" className={"FileOverviewAddButton"} onClick={this.addButtonClicked} aria-label="upload new videofile">
