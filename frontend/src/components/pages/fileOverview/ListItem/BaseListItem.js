...
const BaseListItem = ({ info, actions }) => {
  ...
  let thumbnailWidth = Math.floor(thumbnailImageWidth * thumbnailRescale);
  let thumbnailHeight = Math.floor(thumbnailImageHeight * thumbnailRescale);

  return (
    <div
      className="BaseListItem"
