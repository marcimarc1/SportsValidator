export const parseProcessedPlayers = (csvContent) => {
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      expectedOrder.forEach((header) => {
        ...
        obj[header] = header === "FrameNo" || header === "PlayerKey" ? parseInt(value, 10) : parseFloat(value);
      });
      result.push(obj);
    }
  
    result.sort((a, b) => a.FrameNo === b.FrameNo ? a.PlayerKey - b.PlayerKey : a.FrameNo - b.FrameNo);
