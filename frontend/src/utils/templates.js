function createSoccerTemplate(LENGTH = 91, WIDTH = 50) {
    ...
    let penaltyAreaRight = [
        [LENGTH - PENALTY_AREA_DEPTH, WIDTH / 2 - (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)],
        [LENGTH - PENALTY_AREA_DEPTH, WIDTH / 2 + (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)],
        [LENGTH, WIDTH / 2 + (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)],
        [LENGTH, WIDTH / 2 - (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)]
    ];

    let penaltyAreaLeft = [
        [PENALTY_AREA_DEPTH, WIDTH / 2 - (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)],
        [PENALTY_AREA_DEPTH, WIDTH / 2 + (GOAL_AREA_LENGTH + PENALTY_AREA_LENGTH + GOAL_WIDTH / 2)],
