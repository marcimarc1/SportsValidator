...
export const convertAnnotationToBox = (annotation, horizontalScalingFactor, verticalScalingFactor) => {
    try{
...
export const convertBoxToAnnotation = (boundingBox, horizontalScalingFactor, verticalScalingFactor) => {
    try{
        return {
